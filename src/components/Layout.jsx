    ...
    <div style={{ position: 'relative' }}
      ...
      {show && (
        <div style={{
          ...
          background: '#1a1422', border: '1px solid rgba(143,47,254,0.25)',
          color: '#F1EBF8', fontSize: 12, fontWeight: 500,
          ...
          <div style={{
            ...
            borderRightColor: 'rgba(143,47,254,0.25)',
          }} />
        </div>
      )}
    </div>
        ...
        <div style={{
          ...
          <Tooltip label="Zebrano ERP">
            <div style={{
              ...
              background: 'linear-gradient(135deg, #8F2FFE, #DF53FE)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              cursor: 'pointer', boxShadow: '0 0 20px rgba(143,47,254,0.3)',
            }} onClick={() => navigate('/')}>
                  ...
                  <Tooltip key={item.path} label={item.label}>
                    <div
                      ...
                      style={{
                        ...
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        background: active ? 'rgba(143,47,254,0.18)' : 'transparent',
                        border: active ? '1px solid rgba(143,47,254,0.35)' : '1px solid transparent',
                        color: active ? '#A855FF' : 'var(--z-text-3)',
                        transition: 'var(--z-transition)',
                        position: 'relative',
                      }}
                      onMouseEnter={e => {
                        if (!active) {
                          e.currentTarget.style.background = 'rgba(143,47,254,0.08)'
                    ...
                    >
                      ...
                      {active && (
                        <div style={{
                          ...
                          background: 'linear-gradient(180deg, #8F2FFE, #DF53FE)',
                        }} />
                      )}
                    </div>
                  </Tooltip>
        ...
        <div style={{
          ...
          <Tooltip label="Cerrar sesión">
            <div
              ...
              onMouseEnter={e => { e.currentTarget.style.color = 'var(--z-error)'; e.currentTarget.style.background = 'rgba(248,113,113,0.08)'; }}
