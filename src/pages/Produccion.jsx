              ...
              return (
                ...
                onMouseLeave={e => { e.currentTarget.style.borderColor='var(--z-border)'; e.currentTarget.style.boxShadow='none'; }}>
                  ...
                  <div style={{ marginBottom:12 }}>
                    ...
                    <div style={{ height:6, background:'rgba(143,47,254,0.1)', borderRadius:20 }}>
                  ...
                  <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
                    {p.tipo_trabajo && (
                      <span className="badge" style={{ background:'rgba(143,47,254,0.1)', color:'var(--z-primary-light)', border:'1px solid rgba(143,47,254,0.2)', textTransform:'capitalize' }}>
                        {p.tipo_trabajo}
                      </span>
                    )}
                    {p.valor_final && (
